...
for i=1:20
    mean_th(i)=(pi/4)/(2*R)*sqrt(i*pi/2)
    for j=1:MC
...
plot(1:20,mean_th',1:20,mean(mean_ac'),1:20,m975,1:20,m25)
...
xlim([0 4])
plot(X,th,'--r','LineWidth',2)
    title('$N=2$, 50 simulations','Interpreter','Latex','Fontsize',12)
   grid on
   h=legend('Theoretical Rayleigh CDF','MC experiments');
   set(h,'Interpreter','Latex')
   xlabel('$\frac{E_R}{<E_R>}\sqrt{\pi/2}$','Interpreter','Latex','Fontsize',12)
...
xlim([0 4])
plot(X,th,'--r','LineWidth',2)
    title('$N=3$, 50 simulations','Interpreter','Latex','Fontsize',12)
   grid on
   h=legend('Theoretical Rayleigh CDF','MC experiments');
   set(h,'Interpreter','Latex')
   xlabel('$\frac{E_R}{<E_R>}\sqrt{\pi/2}$','Interpreter','Latex','Fontsize',12)
...
xlim([0 4])
plot(X,th,'--r','LineWidth',2)
    title('$N=4$, 50 simulations','Interpreter','Latex','Fontsize',12)
   grid on
   h=legend('Theoretical Rayleigh CDF','MC experiments');
   set(h,'Interpreter','Latex')
   xlabel('$\frac{E_R}{<E_R>}\sqrt{\pi/2}$','Interpreter','Latex','Fontsize',12)
...
xlim([0 4])
plot(X,th,'--r','LineWidth',2)
    title('$N=10$, 50 simulations','Interpreter','Latex','Fontsize',12)
   grid on
   h=legend('Theoretical Rayleigh CDF','MC experiments');
   set(h,'Interpreter','Latex')
   xlabel('$\frac{E_R}{<E_R>}\sqrt{\pi/2}$','Interpreter','Latex','Fontsize',12)
...
xlim([0 4])
plot(X,th,'--r','LineWidth',2)
    title('$N=20$, 50 simulations','Interpreter','Latex','Fontsize',12)
   grid on
   h=legend('Theoretical Rayleigh CDF','MC experiments');
   set(h,'Interpreter','Latex')
   xlabel('$\frac{E_R}{<E_R>}\sqrt{\pi/2}$','Interpreter','Latex','Fontsize',12)
