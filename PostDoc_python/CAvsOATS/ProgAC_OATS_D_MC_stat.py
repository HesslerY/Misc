...
tilt=zeros((n,1))#arccos(2*rand(n,1)-1)
...
#import os
#import sys#files = []#
#for u in range(0,len(f),10):
#	fig = figure(num=7, figsize=(10, 7), dpi=200, facecolor='w', edgecolor='k')
#	fig.suptitle(r'%2.2f MHz' %(int(round(f[u]/1e6))), fontsize=14, fontweight='bold')
#	subplot(221)
...
#	#ylim(0,7000)
#	subplot(223)
#	hist1=hist(list(abs(Ethoats[:,u]).flatten(1)),30)
#	xlabel(r'V/m')
#	ylabel(r'Occ.')
#	#ylim(0,7000)
#	title(r'$E_\theta$')
#	#xlim(0,70)
#	subplot(224)
#	hist2=hist(list(abs(Ephoats[:,u]).flatten(1)),30)
#	title(r'$E_\phi$')
#	#xlim(0,70)
#	xlabel(r'V/m')
#	ylabel(r'Occ.')
...
figure(2)
plot(f,macth,f,moatsth,f,macph,f,moatsph)
