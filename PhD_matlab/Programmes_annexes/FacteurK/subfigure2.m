...
q025_lin2=Kvrai_lin-1.96*sqrt(1/(N^2)+2*Kvrai_lin/N)/sqrt(Nfreq);
q975_lin2=Kvrai_lin+1.96*sqrt(1/(N^2)+2*Kvrai_lin/N)/sqrt(Nfreq);
...
plot(K,10*log10(Kfinal(:,2)),'bo')
plot(Kvrai_dB,y(2,:),'b');
plot(K,10*log10(Kfinal(:,3)),'bo')
plot(Kvrai_dB,y(3,:),'b');
legend('$K$','$\widehat{K}$ with $N=30$ and $N_\textrm{freq}=30$','95\% CI of $\widehat{K}$ with $N=30$ and $N_\textrm{freq}=30$','95\% theroretical CI of $\widehat{K}$ with $N=30$ and $N_\textrm{freq}=30$')
axis equal
xlabel('$K$')
ylabel('$\widehat{K}$')
grid on
...
%subplot(2,1,1)
plot(K,K,'LineWidth',1,'Color','k')
plot(K,10*log10(Kfinal2(:,1)),'b.')
plot(K,10*log10(Kfinal2(:,2)),'bo')
plot(Kvrai_dB,y2(2,:),'b');
plot(K,10*log10(Kfinal2(:,3)),'bo')
plot(Kvrai_dB,y2(3,:),'b');
legend('$K$','$\widehat{K}$ with $N=50$ and $N_\textrm{freq}=100$','95\% CI of $\widehat{K}$ with $N=50$ and $N_\textrm{freq}=100$','95\% theroretical CI of $\widehat{K}$ with $N=50$ and $N_\textrm{freq}=100$')
axis equal
xlabel('$K$')
ylabel('$\widehat{K}$')
grid on
