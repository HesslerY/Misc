...
Resultabs=Result;    
    Resultll=mean(Resultl);
    Resulttt=mean(Resultt);
    Resultnn=mean(Resultn);
    %    p=1:61;
...
plot((Resultabs),(Resultll),(Resultabs),rllth,(Resultabs),(Resulttt),(Resultabs),rttth,(Resultabs),(Resultnn),(Resultabs),rnnth)
legend('$\rho_{ll}$','$\rho_{ll}$ th.','$\rho_{tt}$','$\rho_{tt}$ th.','$\rho^2$','$\rho^2$ th.')
 ...
 plot(mean(Resultabs),Resulttt(1:52,:)','-b',mean(Resultabs),rttth,'-r')
