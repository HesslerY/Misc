...
for z=1:300
    ...
    filename=sprintf('6palesgraph200phi0_%d.png',sss)
    saveas(gcf,filename,'png')
    optim=[optim; freq(frequence)/1e6 q o1 th1 ph1 o2 th2 ph2 o3 th3 ph3  o4 th4 ph4  o5 th5 ph5  o6 th6 ph6 sum(abs(Rx))/360*q sum(abs(Ry))/360*q sum(abs(Rz))/360*q]
    save('optim200phi0.mat','optim')
end
