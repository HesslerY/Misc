...
[Sx1,Sy1,Sz1] = CIR8th(X_1,Y_1,Z_1);
...
POS(:,3) = -POS(:,3);
POS(:,6) = POS(:,6)+pi;
[Sx2,Sy2,Sz2] = CIR8th(X_1,Y_1,Z_1);
...
[Sx3,Sy3,Sz3] = CIR8th(X_1,Y_1,Z_1);

%CIR 4/8, images in the space defined by x>=0, y<=0, z<=0
POS(:,4) = POS(:,4)+1; %order+1
POS(:,3) = -POS(:,3);
POS(:,6) = POS(:,6)+pi;
[Sx4,Sy4,Sz4] = CIR8th(X_1,Y_1,Z_1);
POS(:,2) = -POS(:,2);
POS(:,3) = -POS(:,3);
...
POS(:,4) = POS(:,4)-1; %order-1
POS(:,1) = -POS(:,1);
[Sx5,Sy5,Sz5] = CIR8th(X_1,Y_1,Z_1);

%CIR 6/8, images in the space defined by x<=0, y>=0, z<=0
POS(:,4) = POS(:,4)+1; %order+1
POS(:,3) = -POS(:,3);
POS(:,6) = POS(:,6)+pi;
[Sx6,Sy6,Sz6] = CIR8th(X_1,Y_1,Z_1);
POS(:,3) = -POS(:,3);
POS(:,5) = pi-POS(:,5);
...
POS(:,2) = -POS(:,2);
POS(:,6) = -POS(:,6);
[Sx7,Sy7,Sz7] = CIR8th(X_1,Y_1,Z_1);

%CIR 8/8, images in the space defined by x<=0, y<=0, z<=0
POS(:,4) = POS(:,4)+1; %order+1
POS(:,3) = -POS(:,3);
POS(:,6) = POS(:,6)+pi;
[Sx8,Sy8,Sz8] = CIR8th(X_1,Y_1,Z_1);
POS(:,1) = -POS(:,1);
POS(:,2) = -POS(:,2);
POS(:,3) = -POS(:,3);
POS(:,4) = POS(:,4)-3;
