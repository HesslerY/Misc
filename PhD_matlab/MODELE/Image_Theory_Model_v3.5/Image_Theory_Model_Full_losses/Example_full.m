...
filename = sprintf('%delem_%dns1s8_full.mat',nbre_elements,round(Lt/(1e-9))); 
load(filename)
...
%Loss coefficient in the full version of the program, you can use different
%loss coefficient for each rectangular direction to simulate openings in the cavity...
Rx = 0.998;
Ry = 0.993;
Rz = 0.998;
